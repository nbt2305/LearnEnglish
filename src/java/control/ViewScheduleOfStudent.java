 ...
 * @author 84877
 */
public class ViewScheduleOfStudent extends HttpServlet {
...
//        classId = Integer.parseInt(request.getParameter("classId"));
        list = timeTableServices.getTimeTablesByUsername(username);
//        ClassOnline classOnline = classOnlineServices.getClassOnlinesById(classId);
        ...
        request.getRequestDispatcher("/Views/ViewScheduleOfStudent.jsp").forward(request, response);
