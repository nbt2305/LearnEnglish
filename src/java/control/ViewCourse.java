...
//        processRequest(request, response);
        ...
        request.setAttribute("course", courseServices.getEnrolledCoursebyUsername(acc.getUsername()));
        request.getRequestDispatcher("/Views/viewAllCourse.jsp").forward(request, response);
    } 
