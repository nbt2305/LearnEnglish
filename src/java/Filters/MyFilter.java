...
public class MyFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(ses.getAttribute("account") == null || (Account) ses.getAttribute("account") == null){
            
            if(url.contains("student") || url.contains("teacher"))
                res.sendRedirect("/LearningEnglish/home");
            else
                chain.doFilter(request, response);
        }else{
            Account acc = (Account) ses.getAttribute("account");
            if(url.contains("student") && acc.getRole()==1){
                res.sendRedirect("/LearningEnglish/home");   
            }
            else if(url.contains("teacher") && acc.getRole() == 2){
                res.sendRedirect("/LearningEnglish/home");
            }
