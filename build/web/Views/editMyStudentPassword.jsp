...
<html>
    ...
    <body>
        <!--        <form action="changeMyStudentPassword" method="post">
                ...
                <div class="col-md-8 border-right">
                    <form action="changeMyStudentPassword" method="post">
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12"><label class="labels">Old Password</label><input oninput="CheckPass(this)" type="password"
                                                                                                        class="form-control" name="oldPassword" required></div>
                                ...
                                <div class="col-md-12"><label class="labels">Confirm Password</label><input type="password"
                                                                                                            class="form-control" name="confirmPassword" required></div>
                            </div>
