    ...
    <body>
            ...
            <div class="header">
                ...
                <div class="top-nav-search">
                    <form action="searchExperts" method="post" style="display: flex">
                        ...
                        <input oninput="searchExperts()" id="name" type="text" name="nameSearch" value="${nameSearch}" class="form-control" placeholder="Search username">
                        <label>Course Id:</label>
                        <select onchange="searchExperts()"id="courseId" name="courseId" style="height: 40px;margin-left: 10px;border-radius: 6px;width: 300px;">
                            <c:if test="${courseId == null}">
                                <option style="text-align: center" value="0">Choose CourseId</option>
                            </c:if>
                            <c:if test="${courseId != null}">
                                ...
                                <c:if test="${courseId != 0}">
                                    <option style="text-align: center"value="${courseId}">${courseId}</option>
                                    <option  style="text-align: center"value="0">Choose CourseId</option>
                                </c:if>

                            </c:if>
                            <c:forEach items="${listCourses}" var="i">
                                <option style="text-align: center"value="${i.courseId}">${i.courseId}</option>
                            </c:forEach>
                        </select>
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    ...
                                    <li><a href="#">View</a></li>
                                    <li><a href="/LearningEnglish/manageTeacher">Manage Request</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="manageExperts">Manage Students</a></li>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="managerViewExpert?username=${i.username}" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="${expertServices.getProfileExpertByUsername(i.username).getAvatar()}" alt="User Image"></a>
                                                        ...
                                                        <td>
                                                            <div class="actions">
                                                                <c:if test="${i.role != 1}">
                                                                    <a onclick="managerUnlockExpert('${i.username}')" class="btn btn-sm bg-success-light me-2" title="Locked">
                                                                        <i class="fe fe-disabled"></i>
                                                                    </a>
                                                                </c:if>
                                                                <c:if test="${i.role == 1}">
                                                                    <a onclick="managerLockExpert('${i.username}')" class="btn btn-sm bg-success-light me-2" title="Normal">
                                                        ...
                                                        <td class="text-end">
                                                            <div class="views" style="display: flex;justify-content: flex-end;"> 
                                                                <c:if test="${i.role != 1}">
                                                                    <a onclick="managerUnlockExpert('${i.username}')" class="btn btn-sm bg-success-light me-2" title="Edit">
                                                                        <i class="fe fe-edit"></i>
                                                                    </a>
                                                                </c:if>
                                                                <c:if test="${i.role == 1}">
                                                                    <a onclick="managerLockExpert('${i.username}')" class="btn btn-sm bg-success-light me-2" title="Edit">
                                                                        <i class="fe fe-edit"></i>
                                                                    </a>
                                                                </c:if>
        ...
        <script>
            ...
            function searchExperts() {
                ...
                $.ajax({
                        type: "GET",
                        url: "/LearningEnglish/searchExperts",
                        data: {
                            content:result
                        },
