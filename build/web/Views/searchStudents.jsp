...
<html lang="en">
    ...
    <body>
                                            ...
                                            <tbody>
                                                <c:forEach items="${listStudents}" var="i">
                                                    <tr>
                                                        ...
                                                        <td>Student</td>
                                                        <td>${i.dateLogin}</td>
                                                        <td><a href="viewScheduleOfStudent?username=${i.username}" class="btn btn-sm bg-success-light me-2" title="Normal">
                                                        ...
                                                        <td>
                                                            <div class="actions">
                                                                <c:if test="${i.role != 2}">
                                                                    <a onclick="managerUnlockStudentSearch('${i.username}')" class="btn btn-sm bg-success-light me-2" title="Locked">
                                                                        <i class="fe fe-disabled"></i>
                                                                    </a>
                                                                </c:if>
                                                                <c:if test="${i.role == 2}">
                                                                    <a onclick="managerLockStudentSearch('${i.username}')" class="btn btn-sm bg-success-light me-2" title="Normal">
                                                        ...
                                                        <td class="text-end">
                                                            <div class="views" style="display: flex;justify-content: flex-end;"> 
                                                                <c:if test="${i.role != 2}">
                                                                    <a onclick="managerUnlockStudentSearch('${i.username}')" class="btn btn-sm bg-success-light me-2" title="Edit">
                                                                        <i class="fe fe-edit"></i>
                                                                    </a>
                                                                </c:if>
                                                                <c:if test="${i.role == 2}">
                                                                    <a onclick="managerLockStudentSearch('${i.username}')" class="btn btn-sm bg-success-light me-2" title="Edit">
                                                                        <i class="fe fe-edit"></i>
                                                                    </a>
                                                                </c:if>
                                                                <a href="managerViewStudent?username=${i.username}" class="btn btn-sm bg-success-light me-2" title="View">
                                                                    <i class="fe fe-eye"></i>
                                                                </a><a href="managerViewStudent?username=${i.username}" class="btn btn-sm bg-success-light me-2" title="Delete">
        ...
        <script>
            function managerLockStudentSearch(username) {
                var s = confirm('Do you want to lock ' + username);
                if (s === true)
                    window.location.href = "/LearningEnglish/managerLockStudentSearch?username=" + username;
            }

            function managerUnlockStudentSearch(username) {
                var s = confirm("Do you want to unlock " + username);
                if (s === true)
                    window.location.href = "managerUnlockStudentSearch?username=" + username;
            }
        </script>
