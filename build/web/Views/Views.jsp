<%-- 
    Document   : home-student
    Created on : Feb 17, 2023, 11:45:50 AM
    Author     : datla
--%>
        ...
        <nav class="navbar navbar-default" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <input style="margin-top: 23px;margin-left: 50px; width:300px" type="text"
                    ...
                    <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="#" class="dropdown-toggle" data-toggle="dropdown">Grade 10 <span
                                            style="margin-left: 50%;" class="fa fa-angle-right"></span></a></li>
                                <li><a href="#" class="dropdown-toggle" data-toggle="dropdown">Grade 11 <span
                                            style="margin-left: 50%;" class="fa fa-angle-right"></span></a></li>
                                <li><a href="#" class="dropdown-toggle" data-toggle="dropdown">Grade 12 <span
                                            style="margin-left: 50%;" class="fa fa-angle-right"></span></a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <img src="https://mdbcdn.b-cdn.net/img/new/avatars/2.webp" class="img-circle"
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href=""> <i style="margin-right: 10px;" class="fa-solid fa-user"></i>Profile</a>
                                </li>
                                <li><a href=""><i style="margin-right: 10px;" class="fa-solid fa-key"></i>Change
                                        password</a></li>
                                <li><a href=""> <i style="margin-right: 10px;"
    ...
    <section id="mu-slider">
        ...
        <div class="mu-slider-single">
            <div class="mu-slider-img">
                <figure>
                    <img src="./Views/assets/img/slider/2.jpg" alt="img">
                </figure>
            </div>
                    ...
                    <div class="mu-latest-courses-area">
                        ...
                        <div id="mu-latest-course-slide" class="mu-latest-courses-content">
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-12">
                                <div class="mu-latest-course-single">
                                    <figure class="mu-latest-course-img">
                                        <a href="#"><img src="./Views/assets/img/courses/2.jpg" alt="img"></a>
                                        <figcaption class="mu-latest-course-imgcaption">
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-12">
                                <div class="mu-latest-course-single">
                                    <figure class="mu-latest-course-img">
                                        <a href="#"><img src="./Views/assets/img/courses/3.jpg" alt="img"></a>
                                        <figcaption class="mu-latest-course-imgcaption">
                                            <a href="#">Academic</a>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="mu-latest-course-single">
                                        ...
                                        <div style="box-shadow: 2px 2px 5px rgba(0,0,0,0.1);"
                                            ...
                                            <h4><a s href="#">Lorem ipsum dolor sit amet.</a></h4>
                                            <p>Teacher : </p>
                                            <div class="mu-latest-course-single-contbottom">
                                                <a class="mu-course-details" href="#">Details</a>
                                                <span class="mu-course-price" href="#">$165.00</span>
                        ...
                        <div class="mu-our-teacher-content">
                            <div class="row">
                                <div class="col-lg-3 col-md-3  col-sm-6">
                                    <div class="mu-our-teacher-single">
                                        <figure class="mu-our-teacher-img">
                                            <img src="./Views/assets/img/teachers/teacher-01.png" alt="teacher img">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="mu-our-teacher-single">
                                        <figure class="mu-our-teacher-img">
                                            <img src="./Views/assets/img/teachers/teacher-02.png" alt="teacher img">
                                            <div class="mu-our-teacher-social">
                                                <a href="#"><span class="fa fa-facebook"></span></a>
                                                <a href="#"><span class="fa fa-twitter"></span></a>
                                                <a href="#"><span class="fa fa-linkedin"></span></a>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="mu-our-teacher-single">
                                        <figure class="mu-our-teacher-img">
                                            <img src="./Views/assets/img/teachers/teacher-03.png" alt="teacher img">
                                            <div class="mu-our-teacher-social">
                                                <a href="#"><span class="fa fa-facebook"></span></a>
                                                <a href="#"><span class="fa fa-twitter"></span></a>
                                                <a href="#"><span class="fa fa-linkedin"></span></a>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="mu-our-teacher-single">
                                        <figure class="mu-our-teacher-img">
                                            <img src="./Views/assets/img/teachers/teacher-04.png" alt="teacher img">
                                            <div class="mu-our-teacher-social">
                                                <a href="#"><span class="fa fa-facebook"></span></a>
                                                <a href="#"><span class="fa fa-twitter"></span></a>
                                                <a href="#"><span class="fa fa-linkedin"></span></a>
                        ...
                        <div class="mu-from-blog-content">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <article class="mu-blog-single-item">
                                        <figure class="mu-blog-single-img">
                                            <a href="#"><img src="./Views/assets/img/blog/blog-1.jpg" alt="img"></a>
                                        ...
                                        <div class="mu-blog-description">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae ipsum
                                                non voluptatum eum
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <article class="mu-blog-single-item">
                                        <figure class="mu-blog-single-img">
                                            <a href="#"><img src="./Views/assets/img/blog/blog-2.jpg" alt="img"></a>
                                            <figcaption class="mu-blog-caption">
                                                <h3><a href="#">Lorem ipsum dolor sit amet.</a></h3>
                                            </figcaption>
                                        </figure>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <article class="mu-blog-single-item">
                                        <figure class="mu-blog-single-img">
                                            <a href="#"><img src="./Views/assets/img/blog/blog-3.jpg" alt="img"></a>
                                            <figcaption class="mu-blog-caption">
                                                <h3><a href="#">Lorem ipsum dolor sit amet.</a></h3>
                                            </figcaption>
                                        </figure>
