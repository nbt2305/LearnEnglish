<%-- 
    Document   : course-archive.jsp
    Created on : Feb 7, 2023, 11:21:56 AM
    Author     : datla
--%>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <article class="mu-blog-single-item">
                                                        <figure class="mu-blog-single-img">
                                                            <a href="/LearningEnglish/courseDetail?courseId=${c.courseId}"><img height="300" src="${c.image}" alt="img"></a>
                                                            <figcaption class="mu-blog-caption">
                                                                <h3><a href="/LearningEnglish/courseDetail?courseId=${c.courseId}">${c.nameCourse}</a></h3>
                                                            </figcaption>                      
                                                        </figure>
                                    ...
                                    <aside class="mu-sidebar">
                                        ...
                                        <div class="mu-single-sidebar">
                                            ...
                                            <ul class="mu-sidebar-catg">
                                                <li><a href="/LearningEnglish/search?categoryId=${categoryId}&skill=listening">Listening</a></li>
                                                <li><a href="/LearningEnglish/search?categoryId=${categoryId}&skill=writing">Writing</a></li>
                                                <li><a href="/LearningEnglish/search?categoryId=${categoryId}&skill=Grammar">Grammar</a></li>
                                                <li><a href="/LearningEnglish/search?categoryId=${categoryId}&skill=reading">Reading</a></li>
