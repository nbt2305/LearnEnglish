            ...
            <div class="rt-container">
                <div class="col-rt-12">
                    <div class="rt-heading">
                        <h1>Expert Profile Page Design Example</h1>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card shadow-sm">
                                            <div class="card-header bg-transparent text-center">
                                                <img class="profile_img" src="${expert.getAvatar()}" alt="student dp">
                                                <h3>${account.getFullname()}</h3>
                                            </div>
                                            <div class="card-body">
                                                <div style="text-align: center;">
                                                    <a href="editMyExpertProfile?username=${account.getUsername()}">Edit Profile</a><br>
                                                    <a href="editMyExpertPassword?username=${account.getUsername()}">Change password</a>
                                                </div>
